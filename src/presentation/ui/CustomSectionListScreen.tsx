...
export const CustomSectionListScreen = () => {
  ...
  return (
    <CustomView>
      <Title title="Lista de personajes" />
      <Card>
        <SectionList
          sections={houses}
          ...
          ListHeaderComponent={() => <Title title="Personajes" safe />}
          ListFooterComponent={() => (
            <Title title={`Secciones : ${houses.length}`} />
          )}
          style={{marginVertical: 10, height: height - top - 120}}
        />
      </Card>
    </CustomView>
  );
